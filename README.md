...
## 🔥🔥🔥 新闻
[2025/04/24] 根据[建议](https://github.com/TW-NLP/ChineseErrorCorrector/issues/17)，我们重新训练纠错模型，并开源训练步骤，支持复现结果，[复现教程]()
...
|:-----------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------|:------------|
| ChinseseErrorCorrectData     | [twnlp/ChinseseErrorCorrectData](https://huggingface.co/datasets/twnlp/ChinseseErrorCorrectData)                                        | 1568885条 | 中文拼写和语法数据集 |
...
下载训练数据集：[twnlp/ChinseseErrorCorrectData](https://huggingface.co/datasets/twnlp/ChinseseErrorCorrectData) ，放在`/data/paper_data` 中。
下载Qwen2.5-7B-Instruct：[Qwen2.5-7B-Instruct](https://huggingface.co/Qwen/Qwen2.5-7B-Instruct) ,放在`/pre_model`中
