...
print(f"Append path: {parent_path}")

import scores as comment_errant
...
def main():
    ...
    annotator = comment_errant.load(args.lang)
    ...
    with ExitStack() as stack, open(args.out, "w", encoding="utf-8") as out_m2:
        ...
        for line in tqdm(zip(*in_files),desc="Processing lines"):
